...
function Navbar() {
  // const { authClient, isAuthenticated, login, logout, initializeAuth } =
  //   useAuthStore();
  ...
  const ProfileModal = () => (
    ...
    >
      <div
        className={`relative w-[220px] p-3 bg-[#1f1f1f] rounded-lg border border-[#ffc252] flex-col justify-center items-center gap-3 inline-flex`}
      >
        {/* Triangle pointer */}
        ...
        <div className="self-stretch justify-start items-center gap-2 inline-flex">
          ...
          <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
            <div className="self-stretch text-white text-sm font-medium font-['Onest'] underline capitalize leading-snug">
              Edit Profile
            </div>
            <div className="self-stretch text-[#ffd166] text-xs font-normal font-['Onest'] leading-snug">
        ...
        >
          ...
          <div className="text-[#070134] text-xs font-semibold font-['Onest'] leading-relaxed">
            Create Collection
          </div>
        </button>
          ...
          {[
            {
              text: "Dashboard",
              icon: Dashbaord,
              onClick: () => navigate("randomId/collections"),
            },
            {
              text: "Public Profile",
              icon: PublicProfile,
            ...
            >
              ...
              >
                ...
                <div className="grow shrink flex jutify-start basis-0 text-[#e6e6eb] text-xs font-medium font-['Onest'] leading-relaxed">
                  {item.text}
                </div>
              </button>
            </div>
      ...
      <div className="relative h-14 py-1 px-6 md:px-2 rounded-lg flex justify-between items-center w-full max-w-6xl mx-auto my-1">
        ...
        >
          {[
            ...
            >
              <Link
                to={item.to}
                className={`text-sm font-medium font-['Onest'] transition-all duration-300 ${
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <motion.div
                className={`bg-[#1a1a1a] h-full w-64 p-5 absolute z-12 right-0 ${
                  hasBackground ? "backdrop-blur-md" : ""
                }`}
                initial={{ x: "100%" }}
                animate={{ x: 0 }}
                exit={{ x: "100%" }}
            ...
            <div className="w-6 h-6 relative">
              <div className="w-6 h-6 left-0 top-0 absolute justify-center items-center inline-flex">
                ...
                >
                  ...
                  />
                  <path
                    d="M9 18.3564V19.1064C9 19.9021 9.31607 20.6652 9.87868 21.2278C10.4413 21.7904 11.2044 22.1064 12 22.1064C12.7956 22.1064 13.5587 21.7904 14.1213 21.2278C14.6839 20.6652 15 19.9021 15 19.1064V18.3564"
                    stroke="white"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M5.25 5.85645C5.11739 5.85645 4.99021 5.90912 4.89645 6.00289C4.80268 6.09666 4.75 6.22384 4.75 6.35645C4.75 6.48905 4.80268 6.61623 4.89645 6.71C4.99022 6.80377 5.11739 6.85645 5.25 6.85645H20.25C20.7141 6.85645 21.1592 7.04082 21.4874 7.36901C21.8156 7.6972 22 8.14232 22 8.60645V19.1064C22 19.5706 21.8156 20.0157 21.4874 20.3439C21.1592 20.6721 20.7141 20.8564 20.25 20.8564H5.25C4.58696 20.8564 3.95107 20.5931 3.48223 20.1242C3.01339 19.6554 2.75 19.0195 2.75 18.3564V6.35645C2.75 5.6934 3.01339 5.05752 3.48223 4.58868C3.95107 4.11984 4.58696 3.85645 5.25 3.85645H18C18.5523 3.85645 19 4.30416 19 4.85645C19 5.40873 18.5523 5.85645 18 5.85645H5.25ZM4.75 8.80595V18.3564C4.75 18.4891 4.80268 18.6162 4.89645 18.71C4.99022 18.8038 5.11739 18.8564 5.25 18.8564H20V8.85645H5.25C5.08079 8.85645 4.91335 8.83929 4.75 8.80595Z"
                  fill="white"
                />
                <path
                  d="M16.5 15.3564C17.3284 15.3564 18 14.6849 18 13.8564C18 13.028 17.3284 12.3564 16.5 12.3564C15.6716 12.3564 15 13.028 15 13.8564C15 14.6849 15.6716 15.3564 16.5 15.3564Z"
                  fill="white"
                />
              </svg>
            </div>
