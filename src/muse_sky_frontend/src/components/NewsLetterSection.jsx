...
const NewsLetterSection = () => {
  return (
    <div className="w-full h-[350px] p-16 flex-col justify-center items-center gap-2 inline-flex">
      <div className="self-stretch flex-col justify-center items-center gap-8 flex">
        <div className="self-stretch text-center text-[#f5fbf2] text-4xl font-bold font-['Bricolage Grotesque'] leading-tight">Ready for Next NFT Drop?</div>
        <div className="w-[400px] h-[60px] p-1.5 rounded-xl border-2 border-[#ffc252] flex-col justify-start items-start gap-2 flex">
