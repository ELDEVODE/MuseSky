...
const BlogPost = ({ title, content, imageUrl }) => (
  <div className="w-full md:w-72 flex-col justify-start items-start gap-4 inline-flex cursor-pointer mb-8 md:mb-0">
...
const BlogCarousel = ({ posts }) => {
  ...
  return (
    <div className="w-full px-4 flex-col justify-center items-between gap-8 flex">
      ...
      <div className="hidden md:flex self-start justify-center items-center gap-4">
        <button
          onClick={prevSlide}
