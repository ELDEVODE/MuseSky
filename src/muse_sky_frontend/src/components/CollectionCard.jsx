    ...
    <div className="h-[320px] px-3 py-4 bg-white/10 rounded-[10px] border border-[#ffa703] flex-col justify-start items-start gap-2 inline-flex">
      <div className="flex-col justify-start items-start gap-1 flex">
        ...
        <div className="w-[240px] justify-start items-center gap-2 inline-flex">
          ...
          <div className="grow shrink basis-0 text-[#ffc252] text-lg font-semibold font-bricolage truncate">{creatorName}</div>
        </div>
      </div>
      <div className="flex-col justify-start items-start gap-2 flex">
        ...
        <div className="flex-col justify-start items-start flex">
          <div className="w-[240px] text-white text-sm font-semibold font-bricolage leading-tight truncate">{collectionName}</div>
        </div>
      </div>
    </div>
  )
