...
const BlogPost = ({ post: propPost, isPreview = false }) => {
  ...
  const post = propPost || blogPosts.find(post => post.id === parseInt(postId));
  ...
  return (
    <div className="max-w-6xl mx-auto bg-black text-white">
        ...
        {!isPreview && (
          <div className="my-12 p-4 bg-gradient-to-r from-[#ffa500] to-[#ffc966] border-2 border-[#ffc252] shadow-lg rounded-sm">
            <div className="flex justify-between items-center">
              <div className="text-black text-base font-medium font-['Onest']">Like what you see? Share with a friend.</div>
              <div className="flex gap-3">
                <button onClick={() => shareOnSocialMedia('x')} className="text-black hover:text-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </button>
                <button onClick={() => shareOnSocialMedia('facebook')} className="text-black hover:text-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                  </svg>
                </button>
                <button onClick={() => shareOnSocialMedia('linkedin')} className="text-black hover:text-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-[50px] flex flex-col md:flex-row justify-between items-start w-full">
              <div className="w-full md:w-[768px] flex-col justify-start items-start gap-5 inline-flex mb-6 md:mb-0">
                <div className="self-stretch text-white text-4xl md:text-5xl font-semibold font-bricolage">More Blogs</div>
                <div className="self-stretch text-[#dfdfd1] text-lg md:text-base font-normal font-onest leading-[30px]">Explore more articles from our team.</div>
              </div>
      ...
      <style jsx global>{`
        ...
        .custom-blog-content h1 { font-size: 2.5em; }
        .custom-blog-content h2 { font-size: 2em; }
        .custom-blog-content h3 { font-size: 1.75em; }
        .custom-blog-content h4 { font-size: 1.5em; }
        .custom-blog-content h5 { font-size: 1.25em; }
        .custom-blog-content h6 { font-size: 1em; }
