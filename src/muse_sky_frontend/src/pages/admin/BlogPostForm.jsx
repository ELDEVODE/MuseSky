...
import {useCreatePost} from "../../store/BackendCallBlog.js";
...
const BlogPostForm = () => {
    ...
    const PreviewModal = () => {
        ...
        return (
            <div className="fixed inset-0 bg-black bg-opacity-75 z-50 overflow-hidden flex items-center justify-center">
                <div
                    className="bg-white dark:bg-gray-800 w-full h-full md:w-11/12 md:h-5/6 lg:w-10/12 lg:h-5/6 xl:w-3/4 xl:h-5/6 rounded-lg shadow-2xl flex flex-col">
                    <div
                        className="sticky top-0 bg-white dark:bg-gray-800 p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
    ...
    const CredentialsModal = () => {
        ...
        const handleSubmit = (e) => {
            e.preventDefault();
            if (!localCredentials.username.trim() || !localCredentials.password.trim()) {
